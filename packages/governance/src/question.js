...
// registrar, the parameters can be described with a QuestionSpec. Once the
// question has been presented to a Registrar, there is a QuestionDetails record
// that also includes the VoteCounter which will determine the outcome and the
// questionHandle that uniquely identifies it.
