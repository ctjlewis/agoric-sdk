...
const committeeRegistrarRoot = '@agoric/governance/src/committeeRegistrar.js';
...
const [
  ...
  makeBundle(committeeRegistrarRoot),
...
async function setupServices(
  ...
  const [
    ...
    installBundle(zoe, committeeRegistrarBundle),
