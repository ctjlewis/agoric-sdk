...
const registrarRoot = '@agoric/governance/src/committeeRegistrar.js';
...
const setupGovernor = async (
  ...
  } = await E(zoe).startInstance(registrarInstall, {}, registrarTerms);
...
test('bootstrap payment', async t => {
  ...
  const registrarInstall = await installBundle(zoe, registrarBundle);
